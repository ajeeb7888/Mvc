...
namespace database.Controllers
{
    public class NationalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nationality1,Country")] Nationality nationality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nationality1,Country")] Nationality nationality)
        {
            if (ModelState.IsValid)
            {
